...
function Message() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      console.log("roommmmmmmmmmmm", room, auth, messages);
      Messages.savedMessages(room, auth, messages).then((res) => {
        // console.log(res)
        console.log(room, auth, showMessages);
        console.log(res);
      });
      Messages.savedMessages(room, auth, showMessages).then((res) => {
        // console.log(res)
        console.log(room, auth, showMessages);
        console.log(res);
      });
