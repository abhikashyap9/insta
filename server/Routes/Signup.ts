...
import {SignUpRoutes} from '../Controller/SignupRoutes'
...
signrouter.post('/signup', SignUpRoutes.Signup)
signrouter.post('/login', SignUpRoutes.Login)
signrouter.get('/userprofile', SignUpRoutes.UserProfile)
signrouter.get('/otherprofile/:id', SignUpRoutes.OtherProfile)
signrouter.put('/follow/:id',userAuthentication, SignUpRoutes.FollowUser)
signrouter.put('/unfollow/:id',userAuthentication, SignUpRoutes.UnfollowUser)
signrouter.post('/resetPassword', SignUpRoutes.ResetEmail)
signrouter.get('/resetEmail/:email', SignUpRoutes.ResetPassowrd)
