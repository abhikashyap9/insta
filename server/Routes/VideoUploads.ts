...
videouploadrouter.post('/singleVideo',userAuthentication,upload.single('video'),trimmed,cloudinaryMiddleware,getClodinaryUrl,async(req:any, res:any) => {
	...
	try{
		const video=await uservideos.save()	
		console.log(video)
